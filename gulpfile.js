...
var gulp = require('gulp'),
    ...
    jsFilesList = ['./src/js/characters/wolf.js',
                   ...
                   './src/js/characters/hare.js',
                   './src/js/components/wolfNavigation.js',
                   './src/js/components/game.js',
                   './src/js/components/gameType.js',
                   './src/js/components/score.js',
                   './src/js/components/lifes.js',
                   './src/js/components/levels.js',
                   './src/js/components/clock.js',
                   './src/js/actions/wolfEvents.js',
                   './src/js/actions/gameEvents.js',
                   './src/js/actions/gameInitialization.js',
                   './src/js/helpers/levelsList.js',
                   './src/js/helpers/keysList.js',
